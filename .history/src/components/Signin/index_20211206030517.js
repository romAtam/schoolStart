 ...
 <FormWrap>
                ...
                <FormContent>
                    <Form action="#">
                        ...
                        <FormInput value={email} onChange={(e)=>setEmail(e.target.value)} autoFocus type='email' required/>
                        <FormLabel htmlFor='for'>password</FormLabel>
                        <FormInput value={pass} onChange={(e)=>setPass(e.target.value)} autoFocus type='password' required/>
